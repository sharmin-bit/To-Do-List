...
function loadTasks(){
    ...
    todolist.forEach(function(task, index)
    {
        ...
        newRow.innerHTML = `
            ...
            <td>
                <a style="border: none; background: none; color:blue" onclick="edit(${index})" data-bs-toggle="modal" data-bs-target="#editmodal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
...
function addTask(){
            ...
            const modefiedDate=' ';
            const validID=idinput.value.trim();
...
function loadSearchTask(res,search){
    ...
    if(search=='Pending')
    {
        ...
        document.getElementById('count').innerHTML = `Pending Tasks ( ${res.length} )`;
    ...
    else if(search=='Completed')
    {
        ...
        document.getElementById('count1').innerHTML = `Completed Tasks ( ${res.length} )`;
            ...
            <td>
                ...
                <a style="border: none; background: none; color:green" onclick="completedTask(${index})"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-square" viewBox="0 0 16 16">
                    ...
                    <path d="m8.354 10.354 7-7a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
                        ...
                        pending.appendChild(newRow);
                        pcount++;
                        document.getElementById('count').innerHTML = `Pending Tasks ( ${pcount} )`;
                        document.getElementById('outputTable').style.display='table';
                    }
                   else if(completed.includes(task))
                   {
                    ...
                    `;
                      completedTable.appendChild(newRow);
                      ccount++;
                      document.getElementById('count1').innerHTML = `Completed Tasks ( ${ccount} )`;
                      document.getElementById('completeTable').style.display='table';
                   };
                });
        }
